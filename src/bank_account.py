...
class BankAccount:
    def __init__(self, username,balance=0.0):
        ...
        file_path = f"data/{safe_username}_transactions.json"
        ...
        if self.transactions:
            ...
            logger.info(f"User {username} loaded. Balance: {self.__balance}")
        else:
            self.__balance = balance
            logger.info(f"New user {username} created. Balance: {balance}")
    ...
    def deposit(self, amount):
        ...
        logger.info(f"{self.username} Deposited {amount}, new balance: {self.__balance}")
    ...
    def withdraw(self, amount):
        ...
        logger.info(f"{self.username} Withdrew {amount}, new balance: {self.__balance}")
